    ...
    <div class="container">
        <div class="row">
            ...
            @auth
                ...
                <a onclick="document.getElementById('logout-form').submit()" title="Log out of account"><i class="fa fa-sign-out"></i></a>
                </div>
            ...
            <input name="text" type="text" placeholder="Search..." class="search-input" id="search-input" />
            </form>
        </div><!--/ Row end -->
    </div><!--/ Container end -->
</div><!-- Main nav end -->
