@extends('panel::layouts.master', ['title' => 'Edit Page'])

@section('content')
    <x-common-breadcrumbs>
        <li><a href="{{ route(config('app.panel_prefix', 'panel') . '.pages.index') }}">Pages List</a></li>
        <li><a>Edit Page</a></li>
    </x-common-breadcrumbs>
                    ...
                    <form id="main-form" role="form" action="{{ route(config('app.panel_prefix', 'panel') . '.pages.update', $page->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="row justify-content-center">
                            ...
                            <div class="form-group col-12">
                                <label for="tinymce-editor">Content <small>(Required)</small></label>
