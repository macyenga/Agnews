@extends('panel::layouts.master', ['title' => 'Change Password'])
                        ...
                        <fieldset class="row justify-content-center">
                            <div class="col-12 d-flex justify-content-center">
                                <div class="form-group col-lg-6">
                                    <label for="password">Current Password <small>(Required, minimum 8 characters)</small></label>
                                    <input id="password" class="form-control" name="password" type="password" required minlength="8" value="{{ old('password') }}">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="new_password">New Password <small>(Required, minimum 8 characters)</small></label>
                                <input id="new_password" class="form-control" name="new_password" type="password" required minlength="8" value="{{ old('new_password') }}">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="new_password_confirmation">Confirm New Password <small>(Required, minimum 8 characters)</small></label>
                                <input id="new_password_confirmation" class="form-control" name="new_password_confirmation" type="password" required minlength="8" value="{{ old('new_password_confirmation') }}">
                            </div>
