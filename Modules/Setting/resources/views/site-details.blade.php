@extends('panel::layouts.master', ['title' => 'Site Details Registration'])

@section('content')
    <x-common-breadcrumbs>
        <li><a>Settings</a></li>
        <li><a>Site Details Registration</a></li>
    </x-common-breadcrumbs>
                    ...
                    <form id="main-form" role="form" action="{{ route(config('app.panel_prefix', 'panel') . '.settings.site-details.edit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="row justify-content-center">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="keywords" class="form-control" name="keywords" value="{{ old('keywords', $siteDetails?->keywords) }}">
                            </div>
                            ...
                            <div class="col-12 d-flex flex-column align-items-center">
                                <div class="form-group relative col-lg-6">
                                    <label>Main Logo <small>(Required)</small></label>
                            ...
                            <div class="col-12 d-flex flex-column align-items-center">
                                <div class="form-group relative col-lg-6">
                                    <label>Secondary Logo <small>(Required)</small></label>
                                    <div class="input-group round">
                                        <input type="text" class="form-control file-input" placeholder="Click to upload">
                                        <span class="input-group-btn">
                                        <button type="button" class="btn btn-success">
