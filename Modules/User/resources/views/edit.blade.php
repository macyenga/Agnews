@extends('panel::layouts.master', ['title' => 'Edit User'])
                        ...
                        <fieldset class="row justify-content-center">
                            ...
                            <div class="accordion mb-3" id="accordionEditPassword">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEditPassword" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionEditPassword">
