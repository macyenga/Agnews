...
this.checkOldIE = function(){
    if ($.browser.msie && $.browser.version < 9) {
       $("#page-content").prepend('<p class="alert alert-warning">Your browser is outdated. Please update it using the <a href="http://browsehappy.com/">browsehappy (Browse Happy)</a> website.</p>');
    }
};
