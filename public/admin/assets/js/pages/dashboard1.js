...
Morris.Donut({
    element: 'donut',
    data: [
        {value: 256, label: 'Morning', formatted: '256 people'},
        {value: 512, label: 'Noon', formatted: '512 people'},
        {value: 1024, label: 'Afternoon', formatted: '1024 people'},
        {value: 2048, label: 'Night', formatted: '2048 people'}
    ],
    colors: [
        '#ffbd15',
        '#13a2a6',
