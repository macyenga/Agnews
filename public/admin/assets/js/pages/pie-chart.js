...
var config2 = {
    type: 'pie',
    data: {
        labels: ["October", "November", "December", "January", "February", "March"], // Replaced Persian month names with English
        datasets: [{
                backgroundColor: [
                    "#14B9D6",
                    "#f55145",
...
var data = {
    labels: [
        "Online",
        "Phone",
        "In-person" // Translated Persian labels to English
    ],
    datasets: [
        {
            data: [300, 50, 100],
...
var config4 = {
    type: 'pie',
    data: {
        labels: ["Associate's Degree", "Bachelor's Degree", "Master's Degree", "PhD"], // Translated Persian labels to English
        datasets: [{
            backgroundColor: [
                "#14B9D6", 
                "#f55145", 
